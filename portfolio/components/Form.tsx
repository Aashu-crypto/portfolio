...
const Form = (props: Props) => {
  ...
  return (
    <div
      className="md:grid md:grid-cols-2 md:mt-14 mt-10 relative"
      id="contact"
    >
      {loading && (
      ...
      <div className="p-10 flex flex-col justify-center">
        ...
        <p className="font-normal text-slate-700 my-5">
          If you are looking to collaborate, discuss a new project, or simply
          want to reach out, please feel free to send me a message. I look
